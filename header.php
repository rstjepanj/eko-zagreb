...
<body>
	<header>
		<nav class="center-content">
			<button id="ham-icon" onclick="hamburgerFunction()"></button>
			<?php wp_nav_menu(array('name' => 'Primarni', 'container' => false, 'menu_class' => 'topnav', 'menu_id' => 'myTopnav', 'depth' => 2, 'link_after' => '<span></span>')); ?>
			<div id="search">
			...
			<button id="mobile-search-button" onclick="searchFunction()"></button>
		</nav>
	</header>
